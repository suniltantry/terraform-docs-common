...
## 2024-06-20
* Add documentation for new [team tokens](/terraform/cloud-docs/api-docs/organization-team-tokens) API that lists team tokens in an organization.
* Add reference to organization team token api on teams, index and navigation page.
* Add a `sort` parameter to the [Team Tokens list API](/terraform/cloud-docs/api-docs/organization-team-tokens#query-parameters) to allow sorting tokens by team name, created by, expired at and last used.
